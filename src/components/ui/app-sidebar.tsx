  ...
  return (
    <div>
      {!isMobile ? (
        <aside
          className={cn(
            "shadow-md h-full p-6 max-w-60 w-full  shadow-black/50 flex-0.5 backdrop-blur-md  bg-[#1a1a1a] rounded-2xl flex items-center text-white justify-between flex-col",
            className,
          )}
        >
          <SidebarContent />
