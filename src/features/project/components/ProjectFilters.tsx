"use client";
import { ProjectFilterState, ProjectTag as ProjectTagType } from "@/features/project/domain";
...
export const ProjectFilters = ({
  ...
  return (
       <div className="text-white p-1 gap-1 w-full max-w-lg mx-auto flex bg-black/20 rounded-full  flex-row items-center mb-6">
